...
<div class="container-narrow">
    ...
    <div class="hero-unit">
        ...
        <a id="btn-setup" class="btn btn-large btn-primary" href="#steps"><?php echo __('Begin setup'); ?></a>
    </div>

    <div id="steps" class="tabbable none">
        <ul id="tabs" class="nav nav-tabs">
            <li><a href="#step-1"><?php echo __('Step 1'); ?></a></li>
            <li><a href="#step-2"><?php echo __('Step 2'); ?></a></li>
            <li><a href="#step-3"><?php echo __('Step 3'); ?></a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="step-1">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="database_host" id="dbHost" placeholder="192.168.0.1">
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <a href="#" onclick="$('#tabs .active').next().find('a').tab('show'); return false;" class="btn"><?php echo __('Next step'); ?></a>
                        </div>
                    </div>
                ...
                <div class="tab-pane" id="step-4">
                    ...
                    <button type="submit" class="btn btn-large btn-block btn-primary"><?php echo __('Install Alf CMS'); ?></button>
                </div>
            </div>
        </form>
    </div>
